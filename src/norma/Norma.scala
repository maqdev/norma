...
trait Row {
  ...
  protected[norma] val data: List[Any]
  ...
  private[norma] def get1(a: String): MayErr[SqlRequestError, Any] = {
    for (
  ...
  private[norma] def getAliased(a: String): MayErr[SqlRequestError, Any] = {
    for (
